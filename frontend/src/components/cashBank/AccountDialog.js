...
const EMPTY = { kind: "bank", name: "", bank_name: "", account_no: "", holder: "", opening_balance: "", opening_date: "", note: "", is_default: false };
...
export default function AccountDialog({ open, account, onClose, onSaved }) {
  ...
  useEffect(() => {
    ...
    setForm(account ? {
      ...
      note: account.note || "", is_default: !!account.is_default,
